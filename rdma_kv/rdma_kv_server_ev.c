...
static void init_global_resources(struct global_ctx *g, struct ibv_context *verbs) {
    ...
    // SRQ recv region
    g->recv_region_bytes = (size_t)RECV_DEPTH * RECV_BUF_SZ;
    ...
    printf("[server] global init: pool_base=0x%llx pool_size=%zu rkey=0x%x, SRQ depth=%d, CQch fd=%d\n",
